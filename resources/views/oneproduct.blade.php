	...
	<head>
		...
		<title>Grossista - 1er site de Grop en algerie</title>
 		...
 		<link type="text/css" rel="stylesheet" href="css/style.css"/>
			<link type="text/css" rel="stylesheet" href="css/styleadditionnel.css"/>
			...
			<div id="top-header">
				<div class="container">
					...
					<ul class="header-links pull-right">
						<li><a href="#"><i class="fa fa-dollar"></i>DA</a></li>
										...
										<div class="cart-list">
											<div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price"><span class="qty">1x</span>DA  980.00</h4>
												</div>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li><a href="store.html">HANOUT</a></li>
						<li><a href="product.html">Produit designe</a></li>
						<li><a href="checkout.html">commende</a></li>
