...
<script type="text/javascript">
   ...
   <div class="row" style='margin-bottom:20px;margin-top:20px'>
    ...
    <div class="col-md-3">
		<div class="row pub"><div style='margin-bottom:5px;margin-left: 130px' class="col"><img  src="img/photo 1.png" width='200px' height='200px'  alt=""></div></div>
		<div class="row pub"><div style='margin-bottom:5px;margin-left: 130px' class="col"><img src="img/photo 11.jpg" width='200px' height='200px' margin='5px' alt=""></div></div>
	</div>

    <!-- fin image coté gauche -->
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:580px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:580px;overflow:hidden;">
            <div data-p="170">
                <img data-u="image" src="img/photo 1.png" />
                <div data-t="0" style="position:absolute;top:320px;left:30px;width:500px;height:40px;font-family:Oswald,sans-serif;font-size:32px;font-weight:200;line-height:1.2;text-align:center;background-color:rgba(255,188,5,0.8);"><a herf=''>Grossita 1er site de gros en algerie</a></div>
            </div>
            <div data-p="170">
                <img data-u="image" src="img/photo 2.png" />
                <div data-t="1" style="position:absolute;top:-50px;left:125px;width:500px;height:40px;font-family:Oswald,sans-serif;font-size:32px;font-weight:200;line-height:1.2;text-align:center;background-color:rgba(255,188,5,0.8);"><a herf=''>Apropos de nous !</a></div>
            </div>
            <div data-p="170">
                <img data-u="image" src="img/photo 3.png" />
                <div data-t="2" style="position:absolute;top:30px;left:-505px;width:500px;height:40px;font-family:Oswald,sans-serif;font-size:32px;font-weight:200;line-height:1.2;text-align:center;background-color:rgba(255,188,5,0.8);"><a herf=''>Vendre sur grossita c'est trés facile</a> </div>
            </div>
            <!-- <div data-p="170">
                <img data-u="image" src="img/photo 3" />
	...
	<div class="col-md-3">
		...
		<div class="row pub"><div style='margin-bottom:5px;margin-left:30px' class="col"><img  src="img/photo 12.jpg" width='200px' height='200px'  alt=""></div></div>
		<div class="row pub"> <div style='margin-left:30px;' class="col"> <img src="img/photo 14.jpg" width='200px' height='200px'  alt=""></div></div>
	</div>
    <!--  fin image coté droite -->

		<!-- fin slider  -->

	<!-- debut carosselle pub -->
<div class="row carossel">
	
	<div  id="jssor_2" style="position:relative;margin:0 auto;top:10px;left:-150px;width:980px;height:150px;overflow:hidden;visibility:hidden;">
	        <!-- Loading Screen -->
	        <div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
	            <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="img/spin.svg" />
	        </div>
	        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:150px;overflow:hidden;">
	            <div>
	                <img data-u="image" src="img/photo 15.JPG" />
	            </div>
	            <div>
	                <img data-u="image" src="img/photo 14.JPG" />
	            </div>
	            <div>
	                <img data-u="image" src="img/photo 15.JPG" />
	            </div>
	            <div>
	                <img data-u="image" src="img/photo 10.JPG" />
	            </div>
	            <div>
	                <img data-u="image" src="img/photo 11.JPG" />
	            </div>
	            <div>
	                <img data-u="image" src="img/photo 12.JPG" />
	            </div>
	            <div>
	                <img data-u="image" src="img/photo 4.JPG" />
	            </div>
	            <div>
	                <img data-u="image" src="img/photo 5.JPG" />
	            </div>
	            <div>
	                <img data-u="image" src="img/photo 6.JPG" />
	            </div>
	            <div>
	                <img data-u="image" src="img/photo 7.JPG" />
	            </div>
	            <div>
	                <img data-u="image" src="img/photo 8.JPG" />
	            </div>
	            <div>
	                <img data-u="image" src="img/photo 9.JPG" />
	            </div>
	        </div>
	        <!-- Bullet Navigator -->
    ...
    <script type="text/javascript">jssor_1_slider_init();</script>
		...
		<div class="section">
			<!-- container -->
			<div class="container">
                 <h3 class="title">BOUTIQUE A L'UNE</h3>
				<!-- row -->
				<div class="row">
					<!-- shop -->
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							<h3 class="title">NOUVELLES ANNONCES</h3>
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12">
                        <div class="section-title">
                            <h3 class="title">TOP ANNONCES</h3>
                            <!-- <div class="section-nav">
                                <ul class="section-tab-nav tab-nav">
                                    <li class="active"><a data-toggle="tab" href="#tab1">Laptops</a></li>
                                    <li><a data-toggle="tab" href="#tab1">Smartphones</a></li>
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">DA 980.00 <del class="product-old-price">DA 990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
		...
		<div id="newsletter" class="section">
			...
			<div class="container">
				...
				<!-- /row -->
                <img src="img/photo 1.png" style="width: 1024PX;height: 350PX">
			</div>
