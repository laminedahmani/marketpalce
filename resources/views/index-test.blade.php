...
<script type="text/javascript">
   ...
   <div class="row" style='margin-bottom:20px;margin-top:20px'>
	<div class="col-md-3">
		...
		<div class="row pub"><div style='margin-bottom:5px;margin-left: 148px' class="col"><img  src="img/003.jpg" width='200px' height='200px'  alt=""></div></div>
		<div class="row pub"><div style='margin-bottom:5px;margin-left: 148px' class="col"><img src="img/002.jpg" width='200px' height='200px' margin='5px' alt=""></div></div>
	</div>
	<div class="col-md-6">
	...
	<div class="col-md-3">
		...
		<div class="row pub"><div style='margin-bottom:5px;margin-left:30px' class="col"><img  src="img/004.jpg" width='200px' height='200px'  alt=""></div></div>
		<div class="row pub"> <div style='margin-left:30px;' class="col"> <img src="img/005.jpg" width='200px' height='200px'  alt=""></div></div>
	</div>
