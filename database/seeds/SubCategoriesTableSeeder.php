...
class SubCategoriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        array('id'=>'105','name'=>'Livre','categorie_id'=>'26'),
        array('id'=>'106','name'=>'Cahier, Accessoire d’écriture et papier','categorie_id'=>'26'),
        array('id'=>'107','name'=>'Matériel de Bureaux','categorie_id'=>'26'),

        array('id'=>'108','name'=>'Distributeur automatique','categorie_id'=>'27'),
        array('id'=>'109','name'=>'Matériel publicité','categorie_id'=>'27'),
        array('id'=>'111','name'=>'Equipement de nettoyage','categorie_id'=>'27'),
        array('id'=>'112','name'=>'Equipement pour hôtel et restauration ','categorie_id'=>'27'),
        array('id'=>'113','name'=>'Equipement supermarché','categorie_id'=>'27'),
        array('id'=>'114','name'=>'Matériel de laboratoire','categorie_id'=>'27'),

        array('id'=>'115','name'=>'Service d’imprimerie','categorie_id'=>'28'),
        array('id'=>'116','name'=>'Emballage','categorie_id'=>'28'),
        array('id'=>'117','name'=>'Produit pour l’étiquetage','categorie_id'=>'28'),
        array('id'=>'118','name'=>'Conditionnement','categorie_id'=>'28'),

        array('id'=>'119','name'=>'Plastique PVC','categorie_id'=>'29'),
        array('id'=>'120','name'=>'Plastique recycle','categorie_id'=>'29'),

        array('id'=>'121','name'=>'Machine','categorie_id'=>'30'),
        array('id'=>'122','name'=>'Outils','categorie_id'=>'30'),
        array('id'=>'123','name'=>'Equipement et matériel','categorie_id'=>'30'),

        array('id'=>'124','name'=>'حلويات الاعراس','categorie_id'=>'31'),
        array('id'=>'125','name'=>'اعمال يدوية','categorie_id'=>'31'),
        array('id'=>'126','name'=>'خياطتك','categorie_id'=>'31'),
        array('id'=>'127','name'=>'اعادة التدوير','categorie_id'=>'31'),
